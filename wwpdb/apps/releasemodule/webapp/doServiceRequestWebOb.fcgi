...
#  - URL mapping and application specific classes are launched from ReleaseWebApp()
...
class MyRequestApp(object):
    ...
    def __call__(self, environment, responseApplication):
        ...
        ###
        relmodule = ReleaseWebApp(parameterDict=self._myParameterDict,verbose=self.__verbose, 
