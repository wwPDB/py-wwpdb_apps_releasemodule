...
class DBLoadUtil(object):
    ...
    def doLoading(self, fileList):
        ...
        #
        #
        scriptfile = getFileName(self.__sessionPath, 'dbload', 'csh')
        listfile   = getFileName(self.__sessionPath, 'filelist', 'txt')
        logfile    = getFileName(self.__sessionPath, 'dbload', 'log')
        clogfile   = getFileName(self.__sessionPath, 'dbload_command', 'log')
        #
